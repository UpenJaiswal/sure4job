...
function workup_ocdi_import_files() {
    ...
    for ($i=1; $i <= 8; $i++) {
        ...
        if ( $i == 6 || $i == 7 ) {
            $redux_options_file = trailingslashit( get_template_directory() ) . 'inc/vendors/one-click-demo-import/default/redux-options6.json';
        } elseif ( $i == 8 ) {
            $redux_options_file = trailingslashit( get_template_directory() ) . 'inc/vendors/one-click-demo-import/default/redux-options8.json';
        }
        $demos[] = array(
