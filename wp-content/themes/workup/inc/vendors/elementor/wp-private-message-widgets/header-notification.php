...
class Workup_Elementor_User_Header_Notification extends Elementor\Widget_Base {

	public function get_name() {
        return 'workup_header_notification';
    }

	public function get_title() {
        return esc_html__( 'Apus Message Notification', 'workup' );
    }
	...
	protected function _register_controls() {
        ...
        $this->add_control(
            'icon_hover_color',
            [
                'label' => esc_html__( 'Color Hover Icon', 'workup' ),
                'type' => Elementor\Controls_Manager::COLOR,
                'scheme' => [
                    'type' => Elementor\Scheme_Color::get_type(),
                    'value' => Elementor\Scheme_Color::COLOR_1,
...
Elementor\Plugin::instance()->widgets_manager->register_widget_type( new Workup_Elementor_User_Header_Notification );