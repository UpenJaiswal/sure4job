...
class Workup_Elementor_Nav_Menu extends Widget_Base {

	public function get_name() {
        return 'workup_nav_menu';
    }

	public function get_title() {
        return esc_html__( 'Apus Navigation Menu', 'workup' );
    }
	...
	protected function _register_controls() {
        ...
        $this->start_controls_section(
            'content_section',
            [
                'label' => esc_html__( 'Navigation Menu', 'workup' ),
        ...
        $this->add_control(
            ...
            [
                ...
                'options' => array(
                    ...
                    'st_line' => esc_html__('Line', 'workup'),
                ),
                'default' => ''
            ]
        );
        ...
        $this->start_controls_section(
            'section_menu_style',
            [
                'label' => esc_html__( 'Menu Item', 'workup' ),
                'tab' => Controls_Manager::TAB_STYLE,
            ]
        );
        ...
        $this->add_control(
            'menu_color',
            [
                'label' => esc_html__( 'Menu Color', 'workup' ),
                'type' => Controls_Manager::COLOR,
                'selectors' => [
        ...
        $this->add_control(
            'menu_color_hover',
            [
                'label' => esc_html__( 'Menu Color Hover', 'workup' ),
                'type' => Controls_Manager::COLOR,
                'selectors' => [
                    // Stronger selector to avoid section style from overwriting
        ...
        $this->add_group_control(
            Group_Control_Typography::get_type(),
            [
                'label' => esc_html__( 'Menu Typography', 'workup' ),
...
Plugin::instance()->widgets_manager->register_widget_type( new Workup_Elementor_Nav_Menu );