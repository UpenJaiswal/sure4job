...
class Workup_Elementor_Banner extends Widget_Base {

	public function get_name() {
        return 'workup_banner';
    }

	public function get_title() {
        return esc_html__( 'Apus Banner', 'workup' );
    }
	...
	protected function _register_controls() {
        ...
        $this->start_controls_section(
            'content_section',
            [
                'label' => esc_html__( 'Banner', 'workup' ),
        ...
        $this->add_control(
            ...
            [
                'name' => 'image',
                'label' => esc_html__( 'Image Background', 'workup' ),
                'type' => Controls_Manager::MEDIA,
                'placeholder'   => esc_html__( 'Upload Image Background Here', 'workup' ),
            ]
        );
        $this->add_control(
            'img_src',
        ...
        $this->add_responsive_control(
            'img_align',
            [
                'label' => esc_html__( 'Image Alignment', 'workup' ),
        ...
        $this->add_responsive_control(
            'content_align',
            [
                'label' => esc_html__( 'Content Alignment', 'workup' ),
                'type' => Controls_Manager::CHOOSE,
                'options' => [
                    'left' => [
                        'title' => esc_html__( 'Left', 'workup' ),
        ...
        $this->add_control(
            ...
            [
                ...
                'options' => array(
                    ...
                    'style3' => esc_html__('Style 3', 'workup'),
                    'style4' => esc_html__('Style 4', 'workup'),
                ),
                'default' => 'style1'
            ]
        );
        $this->add_control(
            'vertical',
            [
                'label' => esc_html__( 'Vertical Content', 'workup' ),
                'type' => Controls_Manager::SELECT,
                'options' => array(
                    'flex-top' => esc_html__('Top', 'workup'),
                    'flex-middle' => esc_html__('Middle', 'workup'),
                    'flex-bottom' => esc_html__('Bottom', 'workup'),
                ),
                'default' => 'flex-middle'
            ]
        );
                    ...
                    ?>
                        <div class="p-static col-xs-<?php echo esc_attr(!empty($content) ? '6':'12' ); ?>">
                            <div class="banner-image">
                                <?php echo workup_get_attachment_thumbnail($img_src['id'], 'full'); ?>
                            </div>
                        </div>
                    <?php } ?>
...
Plugin::instance()->widgets_manager->register_widget_type( new Workup_Elementor_Banner );