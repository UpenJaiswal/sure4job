...
class Workup_Elementor_Popup_Video extends Widget_Base {

	public function get_name() {
        return 'workup_popup_video';
    }

	public function get_title() {
        return esc_html__( 'Apus Popup Video', 'workup' );
    }
	...
	protected function _register_controls() {
        ...
        $this->add_control(
            'video_link',
            [
                'label' => esc_html__( 'Youtube Video Link', 'workup' ),
                'type' => Controls_Manager::TEXT,
                'input_type' => 'url',
            ]
        );
        ...
        $this->add_control(
            ...
            [
                'name' => 'image',
                'label' => esc_html__( 'Background Image', 'workup' ),
                'type' => Controls_Manager::MEDIA,
                'placeholder'   => esc_html__( 'Upload Background Image', 'workup' ),
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'options' => array(
                    ...
                    'st_center' => esc_html__('Center', 'workup'),
                ),
                'default' => ''
            ]
        );
...
Plugin::instance()->widgets_manager->register_widget_type( new Workup_Elementor_Popup_Video );