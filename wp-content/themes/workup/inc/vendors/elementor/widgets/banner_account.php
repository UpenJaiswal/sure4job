...
class Workup_Elementor_Banner_Account extends Widget_Base {

	public function get_name() {
        return 'workup_banner_account';
    }

	public function get_title() {
        return esc_html__( 'Apus Banner Create Account', 'workup' );
    }
	...
	protected function _register_controls() {
        ...
        $this->start_controls_section(
            'content_section',
            [
                'label' => esc_html__( 'Banner Account', 'workup' ),
        ...
        $this->add_control(
            'content',
            [
                'label' => esc_html__( 'Description', 'workup' ),
	...
	protected function render() {
        ...
        <div class="widget-banner-account <?php echo esc_attr($el_class); ?>" <?php echo trim($style_bg); ?>>
            ...
            <?php if ( !empty($btn_text)  ) { ?>
                <a class="btn radius-50 <?php echo esc_attr(!empty($btn_style) ? $btn_style : ''); ?>" href="<?php echo esc_url( ( !empty($link) ) ? $link :'#' ); ?>"><?php echo wp_kses_post($btn_text); ?></a>
            <?php } ?>
        </div>
        <?php
    }
}
Plugin::instance()->widgets_manager->register_widget_type( new Workup_Elementor_Banner_Account );