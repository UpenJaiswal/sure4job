...
class Workup_Elementor_Call_To_Action extends Widget_Base {

	public function get_name() {
        return 'workup_call_to_action';
    }

	public function get_title() {
        return esc_html__( 'Apus Call To Action', 'workup' );
    }
	...
	protected function _register_controls() {
        ...
        $this->add_control(
            ...
            [
                ...
                'placeholder' => esc_html__( 'Enter your description here', 'workup' ),
            ]
        );
        ...
        $this->add_control(
            'btn_link',
            [
                'label' => esc_html__( 'Button Link', 'workup' ),
                'type' => Controls_Manager::TEXT,
                'input_type' => 'url',
        ...
        $this->add_control(
            ...
            [
                ...
                'options' => array(
                    ...
                    'btn-theme' => esc_html__('Theme ', 'workup'),
                ),
                'default' => 'btn-default'
            ]
        );
...
Plugin::instance()->widgets_manager->register_widget_type( new Workup_Elementor_Call_To_Action );