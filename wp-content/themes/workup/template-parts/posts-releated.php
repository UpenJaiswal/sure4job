<?php
    $relate_count = workup_get_config('number_blog_releated', 2);
    $relate_columns = workup_get_config('releated_blog_columns', 2);
...
<div class="related-posts">
    <h4 class="title">
        <span><?php esc_html_e( 'Related Posts', 'workup' ); ?></span>
    </h4>
