...
<div class="apus-offcanvas dark-menu-sidebar hidden-sm hidden-xs"> 
    <div class="offcanvas-top">
        ...
        <div class="clearfix">
            <div class="header-right pull-left">
                <?php if ( class_exists( 'YITH_WCWL' ) && workup_get_config('show_wishlist_btn', true) ):
                    $wishlist_url = YITH_WCWL()->get_wishlist_url();
                ?>
                    <div class="pull-right">
                        <a class="wishlist-icon" href="<?php echo esc_url($wishlist_url);?>" title="<?php esc_attr_e( 'View Your Wishlist', 'workup' ); ?>"><i class="icon_heart_alt"></i>
                ...
                <?php if ( workup_get_config('show_login_account', true) ) { ?>
                    <div class="pull-right">
                ...
                <?php if ( defined('WORKUP_WOOCOMMERCE_ACTIVED') && workup_get_config('show_cartbtn') ): ?>
                    <div class="pull-right">
    ...
    <div class="offcanvas-middle">
        <?php if ( has_nav_menu( 'vertical-menu' ) ): ?>
            <div class="vertical-wrapper">
                <div class="title-vertical bg-theme"><i class="fa fa-bars" aria-hidden="true"></i> <span class="text-title"><?php echo esc_html__('all Departments','workup') ?></span> <i class="fa fa-angle-down show-down" aria-hidden="true"></i></div>
                <?php
                    $args = array(
    ...
    <div class="offcanvas-bottom">
        ...
        <?php } ?>
         <?php
            $social_links = workup_get_config('header_social_links_link');
            $social_icons = workup_get_config('header_social_links_icon');
