...
global $post;
?>
<section id="main-container" class="inner-dashboard <?php echo apply_filters('workup_page_content_class', 'container');?> <?php echo esc_attr(get_post_meta( $post->ID, 'apus_page_layout', true )); ?> ">
