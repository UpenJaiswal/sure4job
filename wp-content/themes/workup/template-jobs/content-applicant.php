            ...
            <div class="right-info ali-right hidden-xs">
                <div class="flex-middle">
                    <div class="applicant-action-button">
                        ...
                        ?>
                        <a data-toggle="tooltip" href="javascript:void(0);" class="btn-approve-job-applied btn-action-icon approve  <?php echo esc_attr($classes); ?>" data-applicant_id="<?php echo esc_attr($post->ID); ?>" data-nonce="<?php echo esc_attr(wp_create_nonce( 'wp-job-board-approve-applied-nonce' )); ?>" title="<?php echo esc_attr_e('Approve Application', 'workup'); ?>"><i class="ti-check"></i></a>

                        <a data-toggle="tooltip" title="<?php echo esc_attr_e('Reject Application', 'workup'); ?>" href="javascript:void(0);" class="btn-action-icon btn-reject-job-applied <?php echo esc_attr($classes); ?> rejec" data-applicant_id="<?php echo esc_attr($post->ID); ?>" data-nonce="<?php echo esc_attr(wp_create_nonce( 'wp-job-board-reject-applied-nonce' )); ?>"><i class="ti-loop"></i></a>
