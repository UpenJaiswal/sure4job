	...
	<div id="comment-<?php comment_ID(); ?>" class="the-comment">
		...
		<div class="comment-box">
			<div class="flex-top clearfix">
				<div class="meta comment-author">
					<div class="info-meta">
						...
						<?php if ( $comment->comment_approved == '0' ) : ?>
							<div class="date"><em><?php esc_html_e( 'Your comment is awaiting approval', 'workup' ); ?></em></div>
						<?php else : ?>
							<div class="date">
				...
				<div class="star-rating clear ali-right" title="<?php echo sprintf( esc_attr__( 'Rated %d out of 5', 'workup' ), $rating ) ?>">
