			...
			<table class="job-table">
				<thead>
					<tr>
						...
						<th class="job-number"><?php esc_html_e('Number Candidates', 'workup'); ?></th>
				...
				<tbody>
					...
					foreach ($alerts->posts as $alert_id) {
						...
						<tr <?php post_class('candidate-alert-wrapper'); ?>>
						    ...
						    <td>
						        <div class="job-found">
						            <?php echo sprintf(esc_html__('Candidates found %d', 'workup'), intval($count_jobs) ); ?>
						        </div>
					        </td>
					        <td>
						        <div class="job-metas">
						    ...
						    <td>
								<a href="javascript:void(0)" class="btn-remove-candidate-alert" data-alert_id="<?php echo esc_attr($alert_id); ?>" data-nonce="<?php echo esc_attr(wp_create_nonce( 'wp-job-board-remove-candidate-alert-nonce' )); ?>"><?php esc_html_e('Remove', 'workup'); ?></a>
							</td>
						</tr><!-- #post-## -->
