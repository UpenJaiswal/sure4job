...
<article class="employee-team-wrapper">
    <div class="employee-team">
        ...
        <div class="employee-information flex-middle">
            ...
            <div class="ali-right">
                <a href="javascript:void(0);" class="btn-employer-remove-employee deleted btn-action-icon" data-employee_id="<?php echo esc_attr($userdata->ID); ?>" data-nonce="<?php echo esc_attr(wp_create_nonce( 'wp-job-board-employer-remove-employee-nonce' )); ?>"><i class="ti-close"></i></a>
            </div>
        </div>
    </div>
</article><!-- #post-## -->
